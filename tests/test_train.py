...
def test_the_ram_budget_reports_the_baseline_beside_it() -> None:
    ...
    assert budget_gb == pytest.approx(RAM_CEILING_GB - baseline_gb - TRAINER_BASE_GB - RAM_RESERVE_GB)
...
def test_a_bigger_machine_does_not_raise_the_ceiling() -> None:
    ...
    assert budget_gb == pytest.approx(24.0 - 20.0 - module.TRAINER_BASE_GB - module.RAM_RESERVE_GB, abs=0.01)
