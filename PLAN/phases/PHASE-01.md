...
> **Audit correction, 2026-09-17:** Three preprocessed rasters exist, but the December filename records `20231205T000214`; the published Case 3 specification requires `2023-12-05 23:57:19 UTC`. Do not treat that file as the verified Case 3 fixture. Its acquisition and footprint need reconciliation. All three TIFFs also lack band descriptions; current research inference explicitly records the historical band2 VV/dB assumption. Earlier “all three fixtures complete” statements below do not close these provenance issues.
